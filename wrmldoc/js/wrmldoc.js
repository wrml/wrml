...
(function() {
  ...
  this.ecoTemplates["apps/schema/show/templates/schema_show"] = function(__obj) {
    ...
    (function() {
      (function() {
        var baseSchema, i, property, propertyName, propertyType, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
        ...
        if (((_ref2 = this.schema.propertyNames) != null ? _ref2.length : void 0) > 0) {
          __out.push('\n\n\n\t\t');
        ...
        if (((_ref4 = this.schema.baseSchemas) != null ? _ref4.length : void 0) > 0) {
          __out.push('\t\n\n\t');
          _ref5 = this.schema.baseSchemas;
          for (i = _k = 0, _len2 = _ref5.length; _k < _len2; i = ++_k) {
            baseSchema = _ref5[i];
            __out.push('\n\n\t\t');
            if (((_ref6 = baseSchema.propertyNames) != null ? _ref6.length : void 0) > 0) {
              __out.push('\n\t\t<div class="section-divider">\n\t\t  <span>\n\t\t  ');
              __out.push(__sanitize(baseSchema.title));
              __out.push(' Properties  \n\t\t  </span>\n\t\t</div>\n\t\t');
            }
            __out.push('\n\n\t\t');
            if (((_ref7 = baseSchema.linkNames) != null ? _ref7.length : void 0) > 0) {
              __out.push('\n\t\t<div class="section-divider">\n\t\t  <span>\n\t\t  ');
              __out.push(__sanitize(baseSchema.title));
              __out.push(' Links  \n\t\t  </span>\n\t\t</div>\n\t\t');
            }

...
this.Wrmldoc.module("ApiNotFoundApp", function(ApiNotFoundApp, App, Backbone, Marionette, $, _) {
  var API, _ref;
  this.startWithParent = false;
  ApiNotFoundApp.Router = (function(_super) {
    __extends(Router, _super);
...
this.Wrmldoc.module("ApiNotFoundApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  var _ref;
  return Show.ApiNotFound = (function(_super) {
    __extends(ApiNotFound, _super);

    function ApiNotFound() {
      _ref = ApiNotFound.__super__.constructor.apply(this, arguments);
      return _ref;
    }
...
this.Wrmldoc.module("DocumentNotFoundApp", function(DocumentNotFoundApp, App, Backbone, Marionette, $, _) {
  var API, _ref;
  this.startWithParent = false;
  DocumentNotFoundApp.Router = (function(_super) {
    __extends(Router, _super);
...
this.Wrmldoc.module("DocumentNotFoundApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  var _ref;
  return Show.DocumentNotFound = (function(_super) {
    __extends(DocumentNotFound, _super);

    function DocumentNotFound() {
      _ref = DocumentNotFound.__super__.constructor.apply(this, arguments);
      return _ref;
    }
...
(function() {
  ...
  this.ecoTemplates["apps/documentNotFound/show/templates/documentNotFound_show"] = function(__obj) {
    ...
    (function() {
      (function() {
        var documentTitle, surrogateKeyValue, _i, _len, _ref;
        ...
        if (this.model.surrogateKeyValues && this.model.surrogateKeyValues.length > 0) {
          __out.push('\n\t\t\t\t\t\t\t\t');
          _ref = this.model.surrogateKeyValues;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            surrogateKeyValue = _ref[_i];
        ...
        __out.push('\n\n\t\t\t\t\t\t\t<div class="control-group">\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<div class="controls">\t\t\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t<button class="documentNotFound-form-button btn btn-inverse" type="button">Create New ');
...
this.Wrmldoc.module("ResourceNotFoundApp", function(ResourceNotFoundApp, App, Backbone, Marionette, $, _) {
  var API, _ref;
  this.startWithParent = false;
  ResourceNotFoundApp.Router = (function(_super) {
    __extends(Router, _super);
...
this.Wrmldoc.module("ResourceNotFoundApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  var _ref;
  return Show.ResourceNotFound = (function(_super) {
    __extends(ResourceNotFound, _super);

    function ResourceNotFound() {
      _ref = ResourceNotFound.__super__.constructor.apply(this, arguments);
      return _ref;
    }

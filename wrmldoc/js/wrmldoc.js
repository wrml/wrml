...
this.Wrmldoc = (function(Backbone, Marionette) {
  ...
  App.handleDocumentOpen = function(e) {
    var el, uri;
    ...
    if (uri) {
      ...
      return App.openDocument(uri, "_blank");
    }
  };
  ...
  App.scrollToView = function(el) {
    var offset, visible_area_end, visible_area_start;
  ...
  App.flashElement = function(el) {
    return el.fadeIn(200).fadeOut(200).fadeIn(200).fadeTo(200, 0.5).fadeTo(200, 1);
  };
...
this.Wrmldoc.module("ApiApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  return Show.Api = (function(superClass) {
    var ResourceCollectionView, ResourceView, self;
    ...
    Api.prototype.onRender = function() {
      ...
      this.viewDocument = $.extend(true, {}, this.model.attributes.model);
      this.viewApi = $.extend(true, {}, this.model.attributes.api);
      resourceArray = this.viewApi.allResources;
      console.log(resourceArray);
      this.resourceCollection = new App.Entities.Collection(resourceArray);
      console.log(this.resourceCollection);
      return this.resourcesSection.show(new ResourceCollectionView({
        collection: this.resourceCollection,
        wrmldocDocroot: this.model.attributes.docroot
      }));
    };
    ...
    Api.prototype.handleDocumentOpen = function(e) {
      return App.handleDocumentOpen(e);
    };

    Api.prototype.showNewDocumentDialog = function() {
      return App.headerView.showNewDocumentDialog();
    };

    Api.prototype.showOpenDocumentDialog = function() {
    ...
    Api.prototype.handleSave = function(e) {
      console.log("handleSave");
      console.log(e);
      return App.saveDocument();
    };

    Api.prototype.handleLoad = function(e) {
    ...
    Api.prototype.handleSwagger = function(e) {
    ...
    Api.prototype.handleAddChildResource = function(e) {
      var eventTarget, parentPath, parentResourceElement, parentResourceId, pathSegment, resource, resourceId;
      ...
      return self.showResourceDialog({
        action: "new",
        title: "New Resource",
    ...
    Api.prototype.showResourceDialog = function(dialogData) {
      var key, parentPath, parentPathLabel, pathSegmentInput, resourceDialog, resourceDialogActionButton, resourceDialogTitleLabel, value;
      ...
      resourceDialog.on('shown', function() {
        return pathSegmentInput.focus();
      });
      return resourceDialog.modal("show");
    };

    Api.prototype.handleResourceDialogAction = function(e) {
      var parentPath, pathSegmentInput, resource, resourceDialog, resourceElement, resourceModel;
      resourceDialog = $("#resourceDialog");
      ...
      this.resourceCollection.add(resourceModel);
      console.log(this.resourceCollection);
      resourceElement = $('.api-resource[data-resource-id="' + resource.id + '"]');
      console.log(resourceElement);
      if (resourceElement) {
        App.scrollToView(resourceElement);
        return App.flashElement(resourceElement);
      }
    };

    Api.prototype.handleResourceDialogPathSegmentInputKeypress = function(e) {
      if (e.which === 13) {
        return $("#resourceDialogActionButton").click();
      }
    };

    Api.prototype.handleResourceDialogSchemaSelect = function(e) {
      var resource, resourceDialog;
      resourceDialog = $("#resourceDialog");
      resource = resourceDialog.data("resource");
      console.log("handleResourceDialogSchemaSelect");
      return this.apiBrowser.show(new App.ApiBrowserApp.Show.ApiBrowser({}));
    };

    Api.prototype.handleEditResource = function(e) {
      return console.log("handleEditResource");
    };

    Api.prototype.handleRemoveResource = function(e) {
      return console.log("handleRemoveResource");
    };

    ResourceView = (function(superClass1) {
      extend(ResourceView, superClass1);

      function ResourceView() {
        return ResourceView.__super__.constructor.apply(this, arguments);
      }

      ResourceView.prototype.template = "api/show/resource_show";

      ResourceView.prototype.initialize = function(options) {
        return this.wrmldocDocroot = options.wrmldocDocroot;
      };

      ResourceView.prototype.onRender = function() {};

      ResourceView.prototype.templateHelpers = function() {
        return {
          wrmldocDocroot: this.wrmldocDocroot
        };
      };
    ...
    ResourceCollectionView = (function(superClass1) {
      extend(ResourceCollectionView, superClass1);

      function ResourceCollectionView() {
        return ResourceCollectionView.__super__.constructor.apply(this, arguments);
      }

      ResourceCollectionView.prototype.itemView = ResourceView;

      ResourceCollectionView.prototype.itemViewOptions = function(model, index) {
        return {
          wrmldocDocroot: this.wrmldocDocroot
        };
      };

      ResourceCollectionView.prototype.initialize = function(options) {
        return this.wrmldocDocroot = options.wrmldocDocroot;
      };

      ResourceCollectionView.prototype.onRender = function() {};
...
(function() {
  ...
  this.ecoTemplates["apps/api/show/templates/api_show"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<section>\n\t\n\t<div id="model-page-header">\n\t  <h1>\n\n\t  \t<img id="title-icon" title="API" src="');
...
(function() {
  this.ecoTemplates || (this.ecoTemplates = {});
  this.ecoTemplates["apps/api/show/templates/resource_show"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        var buttonClass, buttonLabel, defaultSchemaTitle, fullPath, i, isDocroot, j, k, l, len, len1, link, linkMethod, linkName, linkSchemaName, linkTemplate, linkTemplates, links, m, parameterName, parameterToken, parameterType, parentPath, parentPathSegment, parentPathSegments, pathSegment, ref, ref1, ref2, ref3, ref4, ref5, reference, referenceMethod, references, resource, signatureParts;
        ...
        __out.push('\n\n<section class="api-resource" data-resource-id="');
      
        __out.push(__sanitize(resource.id));
      
        __out.push('" data-full-path="');
        ...
        __out.push(__sanitize(this.wrmldocDocroot));
        ...
        if ((parentPath != null ? parentPath.length : void 0) > 1) {
          ...
          __out.push('\n                    ');
          for (j = 0, len = parentPathSegments.length; j < len; j++) {
            parentPathSegment = parentPathSegments[j];
            __out.push('\n\n                        ');
            console.log("parentPathSegment: " + parentPathSegment);
            __out.push('\n                        ');
            if (parentPathSegment) {
              __out.push('\n                            <span><label class="api-resource-parent-path-label" for="resource_');
              __out.push(__sanitize(fullPath));
              __out.push('_pathSegment">');
              __out.push(__sanitize(parentPathSegment));
              __out.push('</label></span>\n                            <span><label class="api-resource-parent-path-label" for="resource_');
              __out.push(__sanitize(fullPath));
              __out.push('_pathSegment"><img class="api-resource-parent-path-icon" src="');
              __out.push(__sanitize(this.wrmldocDocroot));
              __out.push('img/resource.png" /></label></span>\n                        ');
            }
            __out.push('\n\n                    ');
          }
          __out.push('\n\n                ');
        ...
        __out.push('_pathSegment" class="api-resource-segment-input" type="text" title="');
        ...
        __out.push('" readonly="readonly">\n\n                    <div class="btn-group">\n                        <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                            <span class="caret"></span>\n                        </button>\n                        <ul class="dropdown-menu">\n\n                            <li><a class="api-resource-add-child-resource-menu-item" data-resource-id="');
      
        __out.push(__sanitize(resource.id));
      
        __out.push('" tabindex="-1" >Add Child...</a></li>\n\n                            ');
      
        if (!isDocroot) {
          __out.push('\n\n                            <li class="divider"></li>\n\n                            <li><a class="api-resource-edit-resource-menu-item" data-resource-id="');
          __out.push(__sanitize(resource.id));
          __out.push('" tabindex="-1">Edit...</a></li>\n\n                            <li class="divider"></li>\n\n                            <li><a class="api-resource-remove-resource-menu-item" data-resource-id="');
          __out.push(__sanitize(resource.id));
          __out.push('" tabindex="-1">Remove</a></li>\n\n                            ');
        }
        ...
        __out.push('\n                <input type="text" id="resource_');
      
        __out.push(__sanitize(fullPath));
      
        __out.push('_defaultSchema" class="api-resource-default-schema-input wrml-document-opener" data-document-uri="');
      
        __out.push(__sanitize((ref1 = resource.defaultSchema) != null ? ref1.uri : void 0));
      
        __out.push('" value="');
      
        __out.push(__sanitize(defaultSchemaTitle));
      
        __out.push('" readonly="readonly">\n\n                <div class="btn-group">\n                    <button class="btn btn-inverse" type="button">Select...</button>\n                    <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                    <span class="caret"></span>\n                    </button>\n                    <ul class="dropdown-menu">\n                        <li><a tabindex="-1" >Select...</a></li>\n                        <li class="divider"></li>\n                        <li><a class="wrml-document-opener" data-document-uri="');
      
        __out.push(__sanitize((ref2 = resource.defaultSchema) != null ? ref2.uri : void 0));
      
        __out.push('" tabindex="-1" >Open</a></li>\n                        <li class="divider"></li>\n                        <li><a tabindex="-1" >Clear</a></li>\n                    </ul>\n                </div>\n\n            </div>\n\n        </div>\n\n        <table class="table resource-table">\n\n            <thead>\n                <tr>\n                    <th colspan="10"><img class="api-resource-form-icon" src="');
        ...
        if (references) {
          ...
          for (k = 0, len1 = references.length; k < len1; k++) {
            reference = references[k];
            __out.push('\n                        ');
            referenceMethod = reference.method;
            __out.push('\n                        ');
            console.log("Reference Method: " + referenceMethod);
            __out.push('\n\n                        <tr>\n\n                            <td colspan="2">\n\n                                <div class="input-append">\n                                    <input type="text" class="api-relation-input wrml-document-opener" data-document-uri="');
            __out.push(__sanitize(reference.rel));
            __out.push('" value="');
            ...
            parameterName = null;
            __out.push('\n\n                                    ');
            for (i = l = 3, ref3 = signatureParts.length; 3 <= ref3 ? l <= ref3 : l >= ref3; i = 3 <= ref3 ? ++l : --l) {
              __out.push('\n\n                                        ');
            ...
            __out.push('\n\n\t\t\t\t\t\t\t\t<button class="');
            __out.push(__sanitize(buttonClass));
            __out.push('" type="button">');
            __out.push(__sanitize(buttonLabel));
        ...
        if (links) {
          ...
          for (linkSchemaName in links) {
            ...
            for (linkName in linkTemplates) {
              ...
              __out.push('\n\n                            <tr>\n\n                                <td colspan="2">\n\n                                    <div class="input-append">\n                                        <input type="text" class="api-relation-input wrml-document-opener" data-document-uri="');
              __out.push(__sanitize(linkTemplate.rel));
              __out.push('" value="');
              ...
              parameterName = null;
              __out.push('\n\n                                        ');
              for (i = m = 3, ref4 = signatureParts.length; 3 <= ref4 ? m <= ref4 : m >= ref4; i = 3 <= ref4 ? ++m : --m) {
                __out.push('\n\n                                            ');
                parameterToken = signatureParts[i];
                __out.push('\n\n                                            ');
                if (parameterToken === ",") {
              ...
              __out.push(__sanitize((ref5 = linkTemplate.endpoint) != null ? ref5.fullPath : void 0));
              __out.push('" >\n\n                                        <div class="btn-group">\n                                            <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                                <span class="caret"></span>\n                                            </button>\n                                            <ul class="dropdown-menu">\n\n                                                ');
...
// Generated by CoffeeScript 1.10.0
this.Wrmldoc.module("ApiBrowserApp", function(ApiBrowserApp, App, Backbone, Marionette, $, _) {
...
this.Wrmldoc.module("ApiBrowserApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  return Show.ApiBrowser = (function(superClass) {
    var self;

    extend(ApiBrowser, superClass);

    function ApiBrowser() {
      return ApiBrowser.__super__.constructor.apply(this, arguments);
    }

    self = ApiBrowser;

    ApiBrowser.prototype.template = "apiBrowser/show/api_browser_show";
...
(function() {
  this.ecoTemplates || (this.ecoTemplates = {});
  this.ecoTemplates["apps/apiBrowser/show/templates/api_browser_show"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div class="api-browser-content">\n\n    <div class="container-fluid">\n\n        <div class="row">\n\n            <div class="span2">\n                <div class="api-browser-panel-header">APIs</div>\n            </div>\n\n            <div class="span2">\n                <div class="api-browser-panel-header">Resources</div>\n            </div>\n\n            <div class="span3">\n                <div class="api-browser-panel-header">Keys</div>\n            </div>\n\n            <div class="span4">\n                <div class="api-browser-panel-header">Preview</div>\n            </div>\n\n        </div>\n        <div class="row">\n\n            <div class="span2">\n                <div class="wrml-scroll-panel">\n                    <div id="apiBrowserApiJstree"></div>\n                </div>\n            </div>\n\n            <div class="span2">\n                <div class="wrml-scroll-panel">\n                    <div id="apiBrowserResourceJstree"></div>\n                </div>\n            </div>\n\n            <div class="span3">\n                <div class="wrml-scroll-panel">\n                    <div id="apiBrowserKeyPanel"></div>\n                </div>\n            </div>\n\n            <div class="span4">\n\n                <div class="wrml-toolbar-top">\n                    URI:\n                </div>\n\n                <div class="wrml-scroll-panel api-browser-preview-scroll-panel">\n                    <div id="apiBrowserPreviewPanel"></div>\n                </div>\n\n                <div class="wrml-toolbar-bottom">\n                    Footer\n                </div>\n\n            </div>\n\n        </div>\n    </div>\n\n</div>');
...
this.Wrmldoc.module("HeaderApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  return Show.Header = (function(superClass) {
    ...
    Header.prototype.showJsonView = function() {
      console.log("Show JSON View");
      return self.showFormatView("application/json");
    };

    Header.prototype.showYamlView = function() {
      console.log("Show YAML View");
      return self.showFormatView("application/yaml");
    };

    Header.prototype.showFormatView = function(mediaType) {
      var aceEditor, aceEditorModeId, aceEditorSession, documentUri, format, formatView, formatViewFormatSelect, uri;
      ...
      return $.ajax(uri, {
        ...
        success: function(data) {
          ...
          if (data) {
            ...
            return formatView.modal("show");
          }
        }
      });
    };

    Header.prototype.handleFormatViewFormatSelectChange = function(e) {
      var selectedMediaType;
      console.log("handleFormatViewFormatSelectChange");
      console.log(e);
      selectedMediaType = e.currentTarget.value;
      return self.showFormatView(selectedMediaType);
    };
  ...
  this.ecoTemplates["apps/header/show/templates/header"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        ref = this.formats;
        for (mediaType in ref) {
          format = ref[mediaType];
          __out.push('\n                    <option>');
          __out.push(__sanitize(mediaType));
          __out.push('</option>\n                  ');
        }
...
this.Wrmldoc.module("ModelApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  return Show.Model = (function(superClass) {
    ...
    Model.prototype.handleDocumentOpen = function(e) {
      return App.handleDocumentOpen(e);
    };

    Model.prototype.showNewDocumentDialog = function() {
      return App.headerView.showNewDocumentDialog();
    };

    Model.prototype.showOpenDocumentDialog = function() {
      return App.headerView.showOpenDocumentDialog();
    };
          ...
          for (slotName in ref1) {
            ...
            if (slotType === "Text") {
              ...
              if (slotSyntax === "URI") {
                ...
                __out.push('">\n                    <button class="wrml-document-opener btn btn-success" data-document-uri="');
                __out.push(__sanitize(slotValue));
                __out.push('" type="button">GET</button>\n\t\t\t\t</div>\t\n\n\t\t\t\t');
              } else if (isMultiline) {
                __out.push(' \n\t\t\t\t<textarea id="');
                __out.push(__sanitize(slotName));
                __out.push('">');
              ...
              if (slotValue) {
                ...
                for (i = j = 0, len = slotValue.length; j < len; i = ++j) {
                  ...
                  if (elementType === "Text") {
                    ...
                    __out.push('" readonly="readonly">\t\t\t\t\n\t\t\t\t\t\t\t  \t\t\t\t\n\n\t\t\t\t\t\t\t\t\t\t\t<div class="btn-group">\n\n                                                <button class="wrml-document-open-dialog btn btn-inverse" type="button">Open</button>\n                                                <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                                <span class="caret"></span>\n                                                </button>\n                                                <ul class="dropdown-menu">\n                                                    <li><a tabindex="-1" class="wrml-document-open-dialog">Open</a></li>\n\t\t\t\t\t\t\t\t\t\t\t\t\t<li class="divider"></li>\n\t\t\t\t\t\t\t\t\t\t\t\t\t<li><a tabindex="-1" >Clear</a></li>\n\t\t\t\t\t\t\t\t\t\t\t\t\t<li class="divider"></li>\n\t\t\t\t\t\t\t\t\t\t\t\t\t<li><a tabindex="-1" >Remove</a></li>\n\t\t\t\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t\t\t\t\t');
        ...
        if (this.schema.linkCount > 0) {
          ...
          for (linkName in ref4) {
            ...
            if (linkHref) {
              ...
              if (link.method === "GET") {
                __out.push('\n\t\t\t\t\t\t\t\t');
                buttonClass = "btn btn-success wrml-document-opener";
                __out.push('\n\t\t\t\t\t\t\t\t');
              ...
              __out.push('" readonly="readonly">\n\t\t\t\t\t\t\t\t<button class="wrml-document-opener btn btn-inverse" data-document-uri="');
              __out.push(__sanitize(link.rel));
              __out.push('" type="button">Open</button>\n\t\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t</div>\n\n\t\t\t\t\t\n\t\t\t\t\t');
...
this.Wrmldoc.module("RelationApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  return Show.Relation = (function(superClass) {
    ...
    Relation.prototype.handleDocumentOpen = function(e) {
      return App.handleDocumentOpen(e);
    };

    Relation.prototype.showNewDocumentDialog = function() {
      return App.headerView.showNewDocumentDialog();
    };

    Relation.prototype.showOpenDocumentDialog = function() {
      return App.headerView.showOpenDocumentDialog();
    };
...
(function() {
  ...
  this.ecoTemplates["apps/relation/show/templates/relation_show"] = function(__obj) {
    ...
    (function() {
      (function() {
        var i, j, k, len, method, methods, parameterName, parameterToken, parameterType, ref, ref1, ref2, ref3, ref4, ref5, ref6, relationMethod, requestSchemaTitle, responseSchemaTitle, selectedAttribute, selectedMethod, signatureParts;
        ...
        if (selectedMethod !== "DELETE") {
          ...
          __out.push('" readonly="readonly">\n\t\t\t  \t\t\t\t\n\t\t\t\t\t\t\t<div class="btn-group">\n                                <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
          __out.push(__sanitize((ref1 = this.relation.responseSchema) != null ? ref1.uri : void 0));
          __out.push('" type="button">Open</button>\n                                <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                <span class="caret"></span>\n                                </button>\n                                <ul class="dropdown-menu">\n                                    <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
          __out.push(__sanitize((ref2 = this.relation.responseSchema) != null ? ref2.uri : void 0));
          __out.push('" >Open</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" >Clear</a></li>\n                                </ul>\n\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t</div>\t\n\t\t\t\t\t\n\t\t\t\t\t</div>\n\n\t\t\t\t</div>\n\t\t\t');
        }
        ...
        if (selectedMethod !== "GET" && selectedMethod !== "DELETE") {
          ...
          requestSchemaTitle = (ref3 = this.relation.requestSchema) != null ? ref3.title : void 0;
          __out.push('\n\t\t\t\t\t\t\t<input id="requestSchema" type="text" value="');
          __out.push(__sanitize(requestSchemaTitle));
          __out.push('" readonly="readonly">\n\t\t\t  \t\t\t\t\n\t\t\t\t\t\t\t<div class="btn-group">\n                                <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
          __out.push(__sanitize((ref4 = this.relation.requestSchema) != null ? ref4.uri : void 0));
          __out.push('" type="button">Open</button>\n                                <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                <span class="caret"></span>\n                                </button>\n                                <ul class="dropdown-menu">\n                                    <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
          __out.push(__sanitize((ref5 = this.relation.requestSchema) != null ? ref5.uri : void 0));
          __out.push('" >Open</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" >Clear</a></li>\n                                </ul>\n\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t</div>\t\n\n\t\t\t\t</div>\n\t\t\t');
        }
        ...
        for (i = k = 3, ref6 = signatureParts.length; 3 <= ref6 ? k <= ref6 : k >= ref6; i = 3 <= ref6 ? ++k : --k) {
          __out.push('\n\n\t\t\t\t\t\t\t');
          parameterToken = signatureParts[i];
          __out.push('\n\n\t\t\t\t\t\t\t');
          if (parameterToken === ",") {
...
this.Wrmldoc.module("SchemaApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  return Show.Schema = (function(superClass) {
    ...
    Schema.prototype.handleDocumentOpen = function(e) {
      return App.handleDocumentOpen(e);
    };

    Schema.prototype.showNewDocumentDialog = function() {
      return App.headerView.showNewDocumentDialog();
    };

    Schema.prototype.showOpenDocumentDialog = function() {
      return App.headerView.showOpenDocumentDialog();
    };
...
(function() {
  ...
  this.ecoTemplates["apps/schema/show/templates/schema_show"] = function(__obj) {
    ...
    (function() {
      (function() {
        var allPropertyNames, baseSchema, checkedAttribute, choiceDisplayText, choiceValue, choiceValueMap, choices, classAttribute, defaultValue, element, elementChoices, elementSchema, elementSyntax, elementSyntaxTitle, elementType, i, inputType, isKey, j, k, keyCheckedAttribute, keyPropertyNames, l, len, len1, len2, link, linkName, links, property, propertyName, propertyNames, propertySyntax, propertySyntaxTitle, propertyType, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, selectedAttribute;
      
        __out.push('<section>\n\t\n\t<div id="schema-page-header">\n\t  <h1>\n\n\t  \t<img id="title-icon" title="Schema" src="');
        ...
        if (((ref = this.schema.baseSchemas) != null ? ref.length : void 0) > 0) {
          ...
          for (i = j = 0, len = ref1.length; j < len; i = ++j) {
            ...
            __out.push('" readonly="readonly">\t\t\t\t\n\t\t\t\t\t\t  \t\t\t\t\n\t\t\t\t\t\t\t\t\t\t<div class="btn-group">\n\t\t\t\t\t\t\t\t\t\t\t<button class="wrml-document-opener btn btn-inverse" data-document-uri="');
            __out.push(__sanitize(baseSchema.uri));
            __out.push('" type="button">Open</button>\n\t\t\t\t\t\t\t\t\t\t\t<button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n\t\t\t\t\t\t\t\t\t\t\t<span class="caret"></span>\n\t\t\t\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t\t\t\t\t<ul class="dropdown-menu">\n\t\t\t\t\t\t\t\t\t\t\t\t<li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
            __out.push(__sanitize(baseSchema.uri));
            __out.push('" >Open</a></li>\n\t\t\t\t\t\t\t\t\t\t\t\t<li class="divider"></li>\n\t\t\t\t\t\t\t\t\t\t\t\t<li><a tabindex="-1" >Remove</a></li>\n\t\t\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t\t\t\t</td>\n\n\t\t\t                </tr>\n\t\t\t\t\t\t\t');
          }
          ...
          for (i = k = 0, len1 = allPropertyNames.length; k < len1; i = ++k) {
            ...
            if (property.declaringSchemaUri === this.schema.uri) {
              ...
              if (propertyType === "Model") {
                ...
                __out.push('" readonly="readonly">\n\t\t\t  \t\t\t\t\n\t\t\t\t\t\t\t<div class="btn-group">\n                                <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
                __out.push(__sanitize((ref3 = property.schema) != null ? ref3.uri : void 0));
                __out.push('" type="button">Open</button>\n                                <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                <span class="caret"></span>\n                                </button>\n                                <ul class="dropdown-menu">\n                                    <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
                __out.push(__sanitize((ref4 = property.schema) != null ? ref4.uri : void 0));
                __out.push('" >Open</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" >Clear</a></li>\n                                </ul>\n\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t</div>\t\n\n\n\t\t\t\t\t\t');
                ...
                if (propertySyntaxTitle) {
                  ...
                  __out.push('" readonly="readonly">\n\t\t\t\t  \t\t\t\t\n                                <div class="btn-group">\n                                    <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
                  __out.push(__sanitize(propertySyntax.uri));
                  __out.push('" type="button">Open</button>\n                                    <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                    <span class="caret"></span>\n                                    </button>\n                                    <ul class="dropdown-menu">\n                                        <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
                  __out.push(__sanitize(propertySyntax.uri));
                  __out.push('" >Open</a></li>\n                                        <li class="divider"></li>\n                                        <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                        <li class="divider"></li>\n                                        <li><a tabindex="-1" >Clear</a></li>\n                                    </ul>\n                                </div>\n\n\t\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t\t\t');
                }
                ...
                __out.push(__sanitize((ref5 = property.choices) != null ? ref5.title : void 0));
                __out.push('" readonly="readonly">\n\t\t\t  \t\t\t\t\n\t\t\t\t\t\t\t<div class="btn-group">\n                                <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
                __out.push(__sanitize((ref6 = property.choices) != null ? ref6.uri : void 0));
                __out.push('" type="button">Open</button>\n                                <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                <span class="caret"></span>\n                                </button>\n                                <ul class="dropdown-menu">\n                                    <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
                __out.push(__sanitize((ref7 = property.choices) != null ? ref7.uri : void 0));
                __out.push('" >Open</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                </ul>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\t\n\n\n\t\t\t\t\t\t');
                ...
                if (elementType === "Model") {
                  ...
                  __out.push('" readonly="readonly">\n\t\t\t\t  \t\t\t\t\n\t\t\t\t\t\t        <div class="btn-group">\n                                    <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
                  __out.push(__sanitize(elementSchema != null ? elementSchema.uri : void 0));
                  __out.push('" type="button">Open</button>\n                                    <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                    <span class="caret"></span>\n                                    </button>\n                                    <ul class="dropdown-menu">\n                                        <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
                  __out.push(__sanitize(elementSchema != null ? elementSchema.uri : void 0));
                  __out.push('" >Open</a></li>\n                                        <li class="divider"></li>\n                                        <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                        <li class="divider"></li>\n                                        <li><a tabindex="-1" >Clear</a></li>\n                                    </ul>\n                                </div>\n\n\t\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t\t\t');
                  ...
                  if (elementSyntaxTitle) {
                    ...
                    __out.push('" readonly="readonly">\n\t\t\t\t\t  \t\t\t\t\n                                    <div class="btn-group">\n                                        <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
                    __out.push(__sanitize(elementSyntax != null ? elementSyntax.uri : void 0));
                    __out.push('" type="button">Open</button>\n                                        <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                        <span class="caret"></span>\n                                        </button>\n                                        <ul class="dropdown-menu">\n                                            <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
                    __out.push(__sanitize(elementSyntax != null ? elementSyntax.uri : void 0));
                    __out.push('" >Open</a></li>\n                                            <li class="divider"></li>\n                                            <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                            <li class="divider"></li>\n                                            <li><a tabindex="-1" >Clear</a></li>\n                                        </ul>\n                                    </div>\n\t\t\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t\t\t\t');
                  }
                  ...
                  __out.push('" readonly="readonly">\n\t\t\t\t  \t\t\t\t\n                                <div class="btn-group">\n                                    <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
                  __out.push(__sanitize(elementChoices != null ? elementChoices.uri : void 0));
                  __out.push('" type="button">Open</button>\n                                    <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                    <span class="caret"></span>\n                                    </button>\n                                    <ul class="dropdown-menu">\n                                        <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
                  __out.push(__sanitize(elementChoices != null ? elementChoices.uri : void 0));
                  __out.push('" >Open</a></li>\n                                        <li class="divider"></li>\n                                        <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                    </ul>\n                                </div>\n\n\t\t\t\t\t\t\t</div>\t\n\n\t\t\t\t\t\t\t');
                }
              ...
              if (propertyType !== "Model" && propertyType !== "List" && propertyType !== "Collection") {
                ...
                if (propertyType === "Boolean") {
                  ...
                  if (propertyType === "Text") {
                    __out.push(' \n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t');
                    propertySyntaxTitle = property != null ? (ref8 = property.syntax) != null ? ref8.title : void 0 : void 0;
                    __out.push('\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t');
            ...
            if (link.declaringSchemaUri === this.schema.uri) {
              ...
              if (link.responseSchemaTitle || link.requestSchemaTitle) {
                ...
                if (link.responseSchemaTitle) {
                  ...
                  __out.push('" readonly="readonly">\n\t\t\t  \t\t\t\t\n                            <div class="btn-group">\n                                <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
                  __out.push(__sanitize(link.responseSchemaUri));
                  __out.push('" type="button">Open</button>\n                                <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                <span class="caret"></span>\n                                </button>\n                                <ul class="dropdown-menu">\n                                    <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
                  __out.push(__sanitize(link.responseSchemaUri));
                  __out.push('" >Open</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" >Clear</a></li>\n                                </ul>\n                            </div>\n\n\t\t\t\t\t\t</div>\t\n\t\t\t\t\t\t');
                }
                ...
                if (link.requestSchemaTitle) {
                  ...
                  __out.push('" readonly="readonly">\n\t\t\t  \t\t\t\t\n                            <div class="btn-group">\n                                <button class="wrml-document-opener btn btn-inverse" data-document-uri="');
                  __out.push(__sanitize(link.requestSchemaUri));
                  __out.push('" type="button">Open</button>\n                                <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">\n                                <span class="caret"></span>\n                                </button>\n                                <ul class="dropdown-menu">\n                                    <li><a tabindex="-1" class="wrml-document-opener" data-document-uri="');
                  __out.push(__sanitize(link.requestSchemaUri));
                  __out.push('" >Open</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" class="wrml-document-open-dialog" >Edit...</a></li>\n                                    <li class="divider"></li>\n                                    <li><a tabindex="-1" >Clear</a></li>\n                                </ul>\n                            </div>\n\n\t\t\t\t\t\t</div>\t\n\t\t\t\t\t\t');
                }
        ...
        if (((ref9 = this.schema.baseSchemas) != null ? ref9.length : void 0) > 0) {
          __out.push('\t\n\n\t');
          ref10 = this.schema.baseSchemas;
          for (i = l = 0, len2 = ref10.length; l < len2; i = ++l) {
            baseSchema = ref10[i];
            __out.push('\n\n\t\t');
            if (((ref11 = baseSchema.propertyNames) != null ? ref11.length : void 0) > 0) {
              __out.push('\n\t\t<div class="section-divider">\n\t\t  <span>\n\t\t  ');
              __out.push(__sanitize(baseSchema.title));
              __out.push(' Properties  \n\t\t  </span>\n\t\t</div>\n\t\t');
            }
            __out.push('\n\n\t\t');
            if (((ref12 = baseSchema.linkNames) != null ? ref12.length : void 0) > 0) {
              __out.push('\n\t\t<div class="section-divider">\n\t\t  <span>\n\t\t  ');
              __out.push(__sanitize(baseSchema.title));
              __out.push(' Links  \n\t\t  </span>\n\t\t</div>\n\t\t');
            }

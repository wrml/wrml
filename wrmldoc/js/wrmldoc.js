...
this.Wrmldoc = (function(Backbone, Marionette) {
  ...
  App.newDocument = function(wrmlData) {
    var module;
    alert("New Document!");
    module = App.module("ModelApp");
    return module.showView(wrmlData);
  };
...
this.Wrmldoc.module("ApiNotFoundApp", function(ApiNotFoundApp, App, Backbone, Marionette, $, _) {
  ...
  API = {
    show: function(wrmlData) {
      return new ApiNotFoundApp.Show.Controller(wrmlData);
    }
  };
  return ApiNotFoundApp.on("start", function(wrmlData) {
    return API.show(wrmlData);
  });
});
// Generated by CoffeeScript 1.10.0
...
this.Wrmldoc.module("DocumentNotFoundApp", function(DocumentNotFoundApp, App, Backbone, Marionette, $, _) {
  ...
  this.showView = function(wrmlData) {
    return new DocumentNotFoundApp.Show.Controller(wrmlData);
  };
  return DocumentNotFoundApp.on("start", function(wrmlData) {
    return this.showView(wrmlData);
  });
});
// Generated by CoffeeScript 1.10.0
...
this.Wrmldoc.module("DocumentNotFoundApp.Show", function(Show, App, Backbone, Marionette, $, _) {
  return Show.DocumentNotFound = (function(superClass) {
    ...
    DocumentNotFound.prototype.newDocument = function(e) {
      var documentNotFoundErrorReport, newDocumentData, newDocumentSchemaUri, newDocumentUri;
      documentNotFoundErrorReport = this.model.attributes["model"];
      ...
      newDocumentData = this.model;
      return App.newDocument(newDocumentData);
    };
  ...
  this.ecoTemplates["apps/documentNotFound/show/templates/documentNotFound_show"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push('\n\n\t\t\t\t\t\t\t<div class="control-group">\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<div class="controls">\t\t\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t<button id="new-document-button" class="documentNotFound-form-button btn btn-inverse" type="button">Create New ');
...
this.Wrmldoc.module("ResourceNotFoundApp", function(ResourceNotFoundApp, App, Backbone, Marionette, $, _) {
  ...
  API = {
    show: function(wrmlData) {
      return new ResourceNotFoundApp.Show.Controller(wrmlData);
    }
  };
  return ResourceNotFoundApp.on("start", function(wrmlData) {
    return API.show(wrmlData);
  });
});
// Generated by CoffeeScript 1.10.0

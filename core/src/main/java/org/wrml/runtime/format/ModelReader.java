...
class ModelReader {
     ...
     *
     * @param in                  The input stream containing formatted bytes that represent the
     *                            model graph to be read.
     * @param rootModelKeys
     * @param rootModelDimensions The dimensions to apply to the graph's root model.
     * @return The initialized model representing the root of the input stream's
     * model graph.
     * @throws ModelReaderException Thrown if any problems are encountered.
     */

 ...
 * </p>
 * <p>
 * One or more instances of this {@link Annotation} may optionally be added to a {@link LinkSlot} to establish the <i>binding</i> between
 ...
 * Note that a {@link LinkSlotBinding} is not necessary in cases where the referenced document slot's name is the same name as the referrer's slot that holds the link "binding" value.
 * This <i>same slot name</i> case is considered a <i>natural</i> link binding and is enabled by default.
 * </p>
 *
 * @see org.wrml.model.schema.LinkValue
 * @see org.wrml.model.schema.LinkValueBinding
 * @see LinkSlot
 * @see ValueSourceType
 * @see LinkProtoSlot
...
public @interface LinkSlotBinding {
    ...
    /**
     * <p>
     * The slot, within the link's referenced document, that is <i>bound</i> by this {@link LinkSlotBinding}.
     * </p>
     * <p>
     ...
     * </p>
     *
     * @return The slot, within the link's referenced document, that is <i>bound</i> by this {@link LinkSlotBinding}.
     */

...
public interface IntegerValue extends Inextensible, NumericValue {
    ...
    List<Integer> getDisallowedValues();
    ...
    Integer setDefault(Integer defaultValue);

    Integer setDivisibleBy(Integer divisibleBy);

    Integer setMaximum(Integer maximum);

    Integer setMinimum(Integer minimum);
}
